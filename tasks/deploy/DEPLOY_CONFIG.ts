...
export const DEPLOYMENT_NAMES = {
    ...
    // Oracles
    ZRO_USD_SEER_ORACLE: 'ZRO_USD_SEER_ORACLE',
    STG_USD_SEER_ORACLE: 'STG_USD_SEER_ORACLE',
    ARB_USD_SEER_ORACLE: 'ARB_USD_SEER_ORACLE',
    ...
    MARKET_USDO_ORACLE: 'MARKET_USDO_ORACLE',
    STARGATEV2_ORACLE_ARB_USDC: 'STARGATEV2_ORACLE_ARB_USDC',
    STARGATEV2_ORACLE_STG_USDC: 'STARGATEV2_ORACLE_STG_USDC',
    STARGATEV2_ORACLE_ZRO_USDC: 'STARGATEV2_ORACLE_ZRO_USDC',
    // Misc
    PAUSER: 'PAUSER',
...
export type TPostLbp = {
    [key in EChainID]?: {
        ...
        STG_USD_CL_DATA_FEED_ADDRESS: string;
        ARB_USD_CL_DATA_FEED_ADDRESS: string;
...
const POST_LBP: TPostLbp = {
    [EChainID.MAINNET]: {
        ...
        STG_USD_CL_DATA_FEED_ADDRESS: '',
        ARB_USD_CL_DATA_FEED_ADDRESS: '',
    ...
    [EChainID.ARBITRUM]: {
        ZRO_USD_CL_DATA_FEED_ADDRESS: '0x1940fEd49cDBC397941f2D336eb4994D599e568B',
        STG_USD_CL_DATA_FEED_ADDRESS: '0xe74d69E233faB0d8F48921f2D93aDfDe44cEb3B7',
        ARB_USD_CL_DATA_FEED_ADDRESS: '0xb2A824043730FE05F3DA2efaFa1CBbe83fa548D6',
        GMX_USD_CL_DATA_FEED_ADDRESS:
